      ...
      describe("when the recipient is not the zero address", function () {
        describe("when the spender has enough approved balance", function () {
          describe("when the token owner has enough balance", function () {
            ...
            it("transfers the requested amount and decreases the spender allowance and emits a transfer event", async function () {
              await this.token.approve(spender, amountTransfer, {
                from: tokenOwner,
              });
              ...
              ).to.be.bignumber.equal(balanceOfTokenOwner);
        ...
        describe("when the spender does not have enough approved balance", function () {
          describe("when the token owner has enough balance", function () {
            it("reverts", async function () {
              ...
              await this.token.approve(spender, amount.subn(1), {
                from: tokenOwner,
              });
              await expectRevert(
                this.token.transferFrom(tokenOwner, to, amount, {
